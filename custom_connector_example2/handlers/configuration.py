...
import custom_connector_example2.constants as constants
import custom_connector_example2.handlers.validation as validation
import custom_connector_example2.handlers.salesforce as salesforce
from custom_connector_sdk.lambda_handler.handlers import ConfigurationHandler
from custom_connector_example2.handlers.client import HttpsClient, SalesforceResponse

CONNECTOR_OWNER = 'SampleConnectorTest'
CONNECTOR_NAME = 'SamplePythonSalesforceConnectorTest'
                ...
                auth.CustomAuthConfig(
                    ...
                    auth_parameters=[
                        auth.AuthParameter(
                            ...
                            required=True,
                            label="API key",
                            description="Enter a valid Riskreconn API key",
